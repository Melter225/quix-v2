    ...
    <main className="font-poppins">
      <div>
          ...
          >
            <div className="flex lg:flex-1">
              <a href="/" className="-m-1.5 p-1.5">
                ...
                <Image src="/QuixLogo.png" width={96} height={51} alt="" />
              </a>
            </div>
            ...
            <div className="hidden lg:flex lg:gap-x-12">
              {navigation.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-lg font-semibold leading-6 text-gray-200 hover:text-gray-300"
                >
                  {item.name}
                </a>
              ))}
            ...
            <div className="hidden lg:flex lg:flex-1 lg:justify-end mr-2">
              ...
              <a
                className="inline-flex items-center border-2 border-gray-200 hover:bg-gray-400 hover:text-gray-800 hover:text-[1.17rem] hover:shadow-lg hover:shadow-blue-900 py-2 px-7 font-semibold focus:outline-none rounded-[1.3rem] text-lg mt-0 md:mt-0 cursor-pointer transition-colors duration-500 mr-2"
                href="/signin"
              >
                Login{" "}
        ...
        <section className="section-blue-purple text-[#8C8C8C] font-poppins overflow-hidden">
          ...
          >
            <g opacity="0.6" filter="url(#filter0_f_130_929)">
              <ellipse
                ...
                rx="516.531"
                ry="21.3606"
                transform="rotate(42.0877 -30.6393 168.066)"
                fill="url(#paint0_linear_130_929)"
              ></ellipse>
            </g>
            <defs>
              <filter
                id="filter0_f_130_929"
                x="-564.24"
                y="-328.517"
                width="1067.2"
                height="993.167"
              ...
              >
                ...
                <feGaussianBlur
                  stdDeviation="75"
                  result="effect1_foregroundBlur_130_929"
                ></feGaussianBlur>
              </filter>
              <linearGradient
                id="paint0_linear_130_929"
                x1="-547.17"
                y1="168.066"
                x2="485.892"
                y2="168.066"
              ...
              >
                <stop offset="0.469665" stop-color="#BBA7D5"></stop>
                <stop offset="1" stop-color="#64379D"></stop>
              </linearGradient>
            </defs>
          </svg>
          <svg
            className="hidden lg:flex absolute -top-0 -left-8"
            width="410"
            height="837"
            viewBox="0 0 410 837"
            fill="none"
          ...
          >
            <g opacity="0.6" filter="url(#filter0_f_130_928)">
              <ellipse
                ...
                rx="438.892"
                ry="17.2672"
                transform="rotate(42.0877 -66.2988 391.989)"
                fill="url(#paint0_linear_130_928)"
              ></ellipse>
            </g>
            <defs>
              <filter
                id="filter0_f_130_928"
                x="-542.219"
                y="-52.47"
                width="951.84"
                height="888.918"
              ...
              >
                ...
                <feGaussianBlur
                  stdDeviation="75"
                  result="effect1_foregroundBlur_130_928"
                ></feGaussianBlur>
              </filter>
              <linearGradient
                id="paint0_linear_130_928"
                x1="-505.191"
                y1="391.989"
                x2="372.593"
                y2="391.989"
          ...
          <svg
            className="hidden lg:flex absolute inset-x-0 top-20 left-0"
            width="378"
            height="464"
            viewBox="0 0 378 464"
            fill="none"
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <feGaussianBlur
                  stdDeviation="150"
                  result="effect1_foregroundBlur_130_899"
                ></feGaussianBlur>
              </filter>
            </defs>
          </svg>
          <svg
            className="hidden lg:flex absolute top-[5.6rem] right-0 h-dvh"
            width="440"
            height="1009"
            viewBox="0 0 440 1009"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            ...
            <div className="container mx-auto flex items-start md:items-center justify-center flex-col max-w-screen-md px-4 lg:px-1">
              <div className="flex w-full justify-center">
                <div className="bg-gradient-to-r p-[0.12rem] from-[#0500E8] to-[#7000FF] rounded-full">
                  <button className="bg-[#1F1F1F] rounded-full py-2 px-5 text-[#C4C1FF] hover:cursor-default font-semibold">
                    Try For Free
                  </button>
                </div>
              </div>
              <div className="md:text-center w-full">
                ...
                <h3 className="text-xl font-semibold text-gray-200 text-center">
                  Introducing Quix - your academic ally in the digital age
                </h3>{" "}
                <p className="text-gray-200 text-sm text-center">
                  <br></br> With Quix, say goodbye to the days of endless
                  resource hunting. Our sleek interface puts the power of
                  preparation at your fingertips, transforming your browser into
                  a digital classroom, where every click brings you one step
                  closer to academic success. And it&apos;s not just for
                  students. Quix is a versatile tool catering to lifelong
                  learners and adults hungry for knowledge. Whether you&apos;e
                  seeking to master a subject quickly or simply explore new
                  topics efficiently, Quix adapts seamlessly to your needs. Say
                  hello to a smarter, more efficient way to learn with Quix.
                </p>
                <br></br>
                <div className="flex justify-center py-6">
                  <div className="bg-gradient-to-r p-px from-[#7000FF] via-[#5C79E1] to-[#1205B4] rounded-2xl">
                    <a
                      className="inline-flex text-gray-200 bg-gradient-to-r bg-sky-700 shadow-lg shadow-blue-900 border-0 py-2 px-6 focus:outline-none hover:bg-sky-600 hover:shadow-blue-800 transition-colors duration-200 rounded-2xl text-lg cursor-pointer font-semibold"
                      href="/signup"
                    >
                      Get Started
                    </a>
          ...
          <section className="text-gray-200 bg-[#030c17] font-poppins">
            <div className="min-h-dvh pb-28 flex flex-col pt-40 px-5">
              <div className="flex flex-wrap w-full mb-20 px-8">
                <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
                  <h2 className="text-base font-semibold tracking-wider leading-7 text-link mb-3">
                    TESTIMONIALS
                  </h2>
                  <h2 className="text-3xl font-bold tracking-tight text-gray-300 sm:text-4xl mb-3">
                    Unlock Your Potential
                  </h2>
                  <div className="h-1 w-20 bg-link rounded"></div>
                </div>
                <p className="lg:w-1/2 text-base w-full leading-8 text-gray-200">
                  Discover how Quix can transform your learning experience and
                  propel you towards success. With its user-friendly interface
                  and comprehensive features, Quix makes learning efficient,
                  effective, and enjoyable for learners of all ages.
                </p>
              </div>
          ...
          <div className="container px-5 py-36 mx-auto">
            <div className="text-center mb-20">
              <div className="mx-auto max-w-2xl text-center mt-10 mb-5 px-8">
                ...
                <p className="mt-2 text-base leading-8 w-[110%] ml-[-5%] text-gray-200">
                  Discover the suite of innovative features that make Quix the
                  ultimate study companion. From intuitive design to advanced
                  functionality, Quix is tailored to enhance every aspect of
            ...
            <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6 justify-center">
              <div
                className="py-4 md:w-[30%] flex flex-col text-center items-center rounded-2xl border-gray-300 border-2 mr-5 bg-cover bg-no-repeat sm:bg-cover md:bg-auto bg-top"
                style={{ backgroundImage: 'url("/FeaturesBG.png")' }}
              >
                ...
                <div className="flex-grow">
                  <h2 className="text-gray-300 text-xl font-poppins font-semibold mb-3 px-4">
                  ...
                  <div className="bg-[#0B0E0F] h-[85%] mt-4 sm:h-[85%] md:h-[87.6%] md:mt-[-0.21rem] sm:mt-4 lg:mt-4 rounded-b-2xl pt-6 pb-2 px-4">
                    <p className="leading-relaxed text-base">
                      Tailor your study journey with personalized learning paths
                      that adapt to your strengths and weaknesses. Quix&apos;s
                      intelligent algorithms analyze your progress and recommend
                      targeted resources to optimize learning outcomes.
                    </p>
                    <a
                      className="mt-3 text-link inline-flex items-center cursor-pointer hover:text-link_hover transition-colors duration-200"
              ...
              >
                ...
                <div className="flex-grow">
                  ...
                  <div className="bg-[#0B0E0F] h-[85%] mt-4 sm:h-[85%] md:h-[87.6%] md:mt-[-0.21rem] sm:mt-4 lg:mt-4 rounded-b-2xl pt-6 pb-2 px-4">
                    <p className="leading-relaxed text-base">
                      Dive into comprehensive study guides curated by experts in
                      various subjects. Interactive elements and multimedia
                      resources ensure engaging and effective learning
                      experiences.
                    </p>
                    <a
                      className="mt-3 text-link inline-flex items-center cursor-pointer hover:text-link_hover transition-colors duration-200"
              ...
              <div
                className="py-4 md:w-[30%] flex flex-col text-center items-center rounded-2xl border-gray-300 border-2 bg-cover bg-no-repeat sm:bg-cover md:bg-auto bg-top"
                style={{ backgroundImage: 'url("/FeaturesBG.png")' }}
              >
                <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5 flex-shrink-0">
                  {/* <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-10 h-10" viewBox="0 0 24 24">
                ...
                <div className="flex-grow">
                  ...
                  <div className="bg-[#0B0E0F] h-[85%] mt-4 sm:h-[85%] md:h-[87.6%] md:mt-[-0.21rem] sm:mt-4 lg:mt-4 rounded-b-2xl pt-6 pb-2 px-4">
                    <p className="leading-relaxed text-base">
                      Stay on top of your academic goals with real-time progress
                      tracking. Visualize your achievements, track study time,
                      and monitor quiz scores to identify areas for improvement
        ...
        <div className="max-w-screen-xl mx-auto px-5 pt-10 min-h-sceen">
          <div className="flex flex-col items-center">
            <div className="mx-auto max-w-2xl text-center mt-10 mb-5 px-8">
              ...
              <p className="mt-2 text-lg leading-8 w-[110%] ml-[-5%] text-gray-200">
          ...
          <div className="grid divide-y divide-neutral-200 text-gray-200 max-w-4xl mx-auto mt-8 sm:px-8 px-4">
            <div className="py-5">
              <details className="group">
                ...
                <p className="text-neutral-300 mt-3 group-open:animate-fadeIn">
                  Quix is an innovative digital platform designed to
                  revolutionize studying and learning. It provides students and
                  learners of all ages with a range of tools and features to
            ...
            <div className="py-5">
              <details className="group">
                <summary className="flex justify-between items-center font-medium cursor-pointer list-none">
                  <span>
                    How does Quix ensure user privacy and data security?
                  </span>
                  <span className="transition group-open:rotate-180">
                    <svg
                      fill="none"
                ...
                <p className="text-neutral-300 mt-3 group-open:animate-fadeIn">
                  Quix prioritizes user privacy and employs security measures to
                  protect user data. We are committed to implementing best
                  practices for data security. Users can trust that we take
                  their privacy seriously and continuously strive to enhance our
                  security protocols. For more information, users can refer to
                  our Privacy Policy.
                </p>
              </details>
            </div>
            <div className="py-5">
              <details className="group">
                ...
                <p className="text-neutral-300 mt-3 group-open:animate-fadeIn">
                  Yes, Quix is not limited to students and can be utilized by
                  adults who wish to learn about various topics. Its intuitive
                  interface and personalized study features make it suitable for
            ...
            <div className="py-5">
              <details className="group">
                <summary className="flex justify-between items-center font-medium cursor-pointer list-none">
                  <span>
                    What types of study materials are available on Quix?
                  </span>
                  <span className="transition group-open:rotate-180">
                    <svg
                      fill="none"
                ...
                <p className="text-neutral-300 mt-3 group-open:animate-fadeIn">
                  Quix offers a wide range of study materials, including
                  practice questions, educational resources, and interactive
                  learning modules across various subjects and disciplines.
                </p>
              </details>
            </div>
            <div className="py-5">
              <details className="group">
                ...
                <p className="text-neutral-300 mt-3 group-open:animate-fadeIn">
                  Quix provides users with insights into their learning progress
                  by allowing them to review test results, identify areas for
                  improvement, and track their performance over time through
            ...
            <div className="py-5">
              <details className="group">
                ...
                <p className="text-neutral-300 mt-3 group-open:animate-fadeIn">
                  Quix is continuously updated and improved by its developers to
                  enhance user experience, introduce new features, and address
                  any issues or feedback from users. Updates are rolled out
                  regularly to ensure that Quix remains cutting-edge and
                  effective in supporting learning objectives.
                </p>
              </details>
            </div>
            <div className="py-5 mb-12">
              <details className="group">
                ...
                <p className="text-neutral-300 mt-3 group-open:animate-fadeIn">
                  Quix does offer a free plan, but it includes a limited amount
                  of Credits, and once you run out of them, you will have to
                  switch to a paid plan such as the Plus, Premium, and Premium
                  Annual plans.
                </p>
              </details>
            </div>
          ...
          <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
            ...
            <div className="space-y-4">
              ...
              <p className="text-base leading-6 text-gray-300">
                Pioneering Tomorrow&apos;s Education
              </p>
              <div className="flex space-x-6">
            ...
            <div className="flex-grow flex flex-wrap md:pl-[10rem] -mb-10 md:mt-0 mt-10 md:text-left text-center">
              <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                <h3 className="text-lg tracking-wide font-semibold leading-6 text-gray-300">
                  Quix
                </h3>
                <ul role="list" className="mt-6 space-y-4 mb-16">
                  <li>
                    <a
                      href="/about"
                      className="text-base cursor-pointer leading-6 text-gray-200 hover:text-gray-300"
                    >
                      About
                    </a>
                  </li>
