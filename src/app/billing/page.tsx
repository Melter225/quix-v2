      ...
      <div>
        ...
        <section className="text-gray-200 font-poppins overflow-hidden">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-col text-center w-full mb-20">
              ...
              <div className="flex mx-auto border-2 border-link rounded-lg overflow-hidden mt-3 -mb-10">
                <button
                  className={`${
                    clicked ? "" : "bg-link"
                  } py-1 px-4 text-gray-200 focus:outline-none`}
                  onClick={toggleFalse}
                >
                  Monthly
                </button>
            ...
            <div
              className={`${clicked ? "hidden" : "block"} flex flex-wrap -m-4`}
            >
              <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
                <div className="h-full p-6 rounded-xl border-2 border-gray-300 flex flex-col relative overflow-hidden bg-navy">
                  <h2 className="text-sm tracking-widest font-poppins mb-1 font-semibold">
                    BASIC
                  </h2>
                  <h1 className="text-5xl text-gray-300 pb-4 mb-4 border-b border-gray-200 leading-none font-semibold tracking-tight">
                    Free
                  </h1>
                  <p className="flex items-center text-gray-200 mb-2">
                    ...
                    Limited access to customized quizzes and documents
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                      <svg
                    ...
                    Access to AI with capabilities of GPT-3.5 Turbo
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                      <svg
                    ...
                    Access to videos meticulously chosen to reinforce
                    comprehension
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                    ...
                    Ability to redo missed quiz questions once
                  </p>
                  <p className="flex items-center text-gray-200 mb-6">
                    ...
                    Access to AI approved public notes pages
                  </p>
                  <a
                    className="flex items-center mt-auto text-white bg-gray-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-500 font-semibold rounded-md transition-colors duration-200"
                    href="/signin"
                  >
                    Login
                  </a>
                  <p className="text-xs text-gray-200 mt-3">
                    Subscriptions are non-refundable. Terms and conditions
                    apply.
                  </p>
                </div>
              </div>
              <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
                <div className="h-full p-6 rounded-xl border-2 border-link flex flex-col relative overflow-hidden bg-navy">
                  <span className="bg-link text-gray-200 px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">
                    POPULAR
                  </span>
                  <h2 className="text-sm tracking-widest font-poppins mb-1 font-bold">
                    PLUS
                  </h2>
                  <h1 className="text-5xl text-gray-300 leading-none flex items-center pb-4 mb-4 border-b border-gray-200">
                    ...
                    <span className="text-lg ml-1 font-semibold text-gray-200">
                      /mo
                    </span>
                  </h1>
                  <p className="flex items-center text-gray-200 mb-2">
                    ...
                    Up to 40x access to customized quizzes and documents
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-emerald-600 text-white rounded-full flex-shrink-0">
                      <svg
                    ...
                    Access to AI with capabilities of GPT-4o and GPT-4 Turbo
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-emerald-600 text-white rounded-full flex-shrink-0">
                      <svg
                    ...
                    Access to websites to bolster and correct user understanding
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-emerald-600 text-white rounded-full flex-shrink-0">
                      <svg
                    ...
                    Ability to redo missed questions unlimited times
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-emerald-600 text-white rounded-full flex-shrink-0">
                      <svg
                    ...
                    Key terms highlighted + interactive quizzes for key terms in
                    notes pages
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-emerald-600 text-white rounded-full flex-shrink-0">
                    ...
                    Tailored sorting algorithms for quizzes by score, question
                  ...
                  <a
                    className="flex items-center mt-auto text-gray-200 bg-link border-0 py-2 px-4 w-full focus:outline-none hover:bg-link_hover font-semibold rounded-md transition-colors duration-200"
                    href="/payment"
                  >
                    Get Plus
                  </a>
              ...
              <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
                <div className="h-full p-6 rounded-xl border-2 border-gray-300 flex flex-col relative overflow-hidden bg-navy">
                  ...
                  <p className="flex items-center text-gray-200 mb-2">
                    ...
                    Up to 80x access to customized quizzes and documents
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-emerald-600 text-white rounded-full flex-shrink-0">
                      <svg
                    ...
                    Access to AI with capabilities of Whisper V1
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-emerald-600 text-white rounded-full flex-shrink-0">
                      <svg
                    ...
                    Unlimited interactive audio AI &quot;Luna&quot; in real time
                    to learn about a new topic or discuss errors
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-emerald-600 text-white rounded-full flex-shrink-0">
                      <svg
                    ...
                    Comprehensive sorting algorithm for quizzes, considering the
                    importance of several factors
                  </p>
                  <p className="flex items-center text-gray-200 mb-2">
                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-emerald-600 text-white rounded-full flex-shrink-0">
                      <svg
                  ...
                  <p className="flex items-center text-gray-200 mb-6">
                    ...
                    All the features in Plus
                  </p>
                  <a
                    className="flex items-center mt-auto text-gray-200 bg-emerald-600 border-0 py-2 px-4 w-full focus:outline-none hover:bg-emerald-700 font-semibold rounded-md transition-colors duration-200"
                    href="/payment"
                  >
                    Get Premium
                  </a>
            ...
            <div
              className={`${clicked ? "block" : "hidden"} flex flex-wrap -m-4`}
            >
              <div className="mx-auto max-w-2xl rounded-2xl ring-1 ring-gray-200 bg-navy lg:mx-0 lg:flex lg:max-w-none">
                <div className="p-8 sm:p-10 lg:flex-auto">
                  ...
                  <p className="mt-6 text-base leading-7 text-gray-200">
                    The Premium Annual plan includes all the perks and features
                    of the premium plan at an annual subscription rate,
                    featuring a 17% discount.
                  </p>
                  <div className="mt-10 flex items-center gap-x-4">
                    <h4 className="flex-none text-lg font-semibold leading-6 text-indigo-400">
                      What&apos;s included
                    </h4>
                  ...
                  <div className="rounded-2xl bg-gray-300 py-10 text-center ring-1 ring-inset ring-gray-700/5 lg:flex lg:flex-col lg:justify-center lg:py-[5.5rem]">
                    <div className="mx-auto max-w-xs px-8">
                      ...
                      <div className="mx-auto max-w-2xl sm:text-center">
                        <h2 className="text-lg mt-1 font-bold tracking-tight text-gray-700 sm:text-xl">
                          17% Discount
                        </h2>
                      </div>
                      <a
                        className="flex items-center mt-10 text-gray-200 bg-emerald-600 border-0 py-2 px-4 w-full focus:outline-none hover:bg-emerald-700 font-semibold rounded-md transition-colors duration-200"
                        href="/payment"
                      >
                        Get Premium Annual
                      </a>
