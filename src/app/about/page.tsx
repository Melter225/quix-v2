  ...
  return (
    <main className="font-poppins">
      <div>
        ...
        <p className="lg:w-4/4 w-full mt-5 leading-relaxed text-gray-200 text-opacity-95">Quix began as a passion project in September 2023 when I believed I could create a project that integrated with an educational app and AI to help me prepare for my tests. I created early branding for Quix, including a logo, which was reworked multiple times, and social media accounts before continuing its development. A few months later, in late October, I had completed the base for the login mechanism and the studying mechanism. As I continued to flesh out the project, I believed it was near completion by January 2024. I bought the temporary domain &quot;quixedu.com&quot; to use for testing purposes. However, the UI was extremely unprofessional. The bulk of the project was additionally in HTML, CSS, and JavaScript, languages that are typically not used in deployment. In February 2024, I completely reworked the UI using Next.js and Tailwind CSS. At the time, I was also pivoting on the idea of Quix as an app; to make it more widely accessible, it no longer paired with a specific educational website, but was a standalone app. Quix can additionally now be used to learn more information about a topic. By March 2024, I had completed the final UI and was beginning to incorporate the logic I had already programmed in Flask and JavaScript. By May, Quix was completed and was being advertised on the social media accounts I had previously created for it, leading up to the current version of Quix.</p>
            </div>
        </div>
        ...
        <section className="text-gray-200 font-poppins">
          <div className="container px-5 py-24 mx-auto flex flex-wrap">
            ...
            <div className="md:w-3/5 md:pl-6">
              <p className="leading-relaxed text-base">We&apos;re excited to showcase an array of icons across Quix, each meticulously curated to enhance your engagement. These icons, crafted by talented designers including <a className="text-link hover:text-link_hover transition-colors duration-200" href="https://www.flaticon.com/free-icons/credit-card" title="credit card icons">Freepik</a>, <a className="text-link hover:text-link_hover transition-colors duration-200" href="https://www.flaticon.com/free-icons/upward-arrow" title="upward arrow icons">BW Designer</a>, <a className="text-link hover:text-link_hover transition-colors duration-200" href="https://www.flaticon.com/free-icons/repeat" title="repeat icons">th studio</a>, <a className="text-link hover:text-link_hover transition-colors duration-200" href="https://www.flaticon.com/free-icons/about" title="about icons">Ilham Fitrotul Hayat</a>, <a className="text-link hover:text-link_hover transition-colors duration-200" href="https://www.flaticon.com/free-icons/settings" title="settings icons">srip</a>, and <a className="text-link hover:text-link_hover transition-colors duration-200" href="https://www.flaticon.com/free-icons/login" title="login icons">berkahicon</a> are integral to our platform&apos;s visual identity and functionality. By incorporating their work, we aim to create a visually rich and intuitive experience for our users. From navigating our interface to exploring our features, these icons play a crucial role in simplifying tasks and elevating user interactions. We extend our heartfelt gratitude to all the creators whose artistry enriches the Quix experience.</p>
            </div>
          </div>
        </section>
