        ...
        <section className="text-gray-200 font-poppins relative">
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="mt-10">
              ...
              <button
                type="submit"
                className="block lg:w-1/2 md:w-2/3 mx-auto bg-emerald-600 hover:bg-emerald-700 transition duration-300 mt-4 py-2 rounded-xl text-gray-200 font-semibold mb-2 cursor-pointer text-center"
              >
                Submit
              </button>
            </div>
