              ...
              <div className="flex flex-col sm:flex-row mt-10">
                <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                  ...
                  <div className="flex flex-col items-center text-center justify-center">
                    <h2 className="font-medium font-poppins mt-4 text-gray-300 text-lg">
                      Phoebe Caulfield
                    </h2>
                ...
                <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                  <p className="leading-relaxed text-base mb-4">
                    At Quix, personalization is at the core of everything we do.
                    We believe in tailoring every aspect of your experience to
                    suit your unique needs and preferences. One of the key ways
                    we achieve this is through our personalized test generation
                    feature. When you interact with Quix, whether it&apos;s to
                    prepare for an exam or to expand your knowledge, our
                    platform dynamically generates questions specifically
                    tailored to the content and description of the test
                    you&apos;re taking. This ensures that each question is
                    relevant and aligned with your study goals, maximizing the
                    effectiveness of your learning experience.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap w-full mb-20">
              <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
                <h1 className="sm:text-3xl text-2xl font-medium font-poppins mb-2 text-gray-300">
              ...
              <p className="lg:w-1/2 w-full leading-relaxed text-base text-gray-200">
                Moreover, Quix offers premium features that further enhance
                personalization. With our premium subscription, you gain access
                to advanced features such as viewing your personal test scores
                and the prioritization of tests based on your performance and
                study goals. Imagine having a dashboard that not only displays
                your test scores but also provides insights into which tests
                require your immediate attention, helping you optimize your
                study time and focus on areas that need improvement.
              </p>
            </div>
          </div>
        </section>
        <section className="text-gray-200 font-poppins">
          <div className="container flex flex-wrap px-5 py-24 mx-auto items-center">
            <div className="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
              <h1 className="sm:text-3xl text-2xl font-medium font-poppins mb-2 text-gray-900">
                Pitchfork Kickstarter Taxidermy
              </h1>
              <p className="leading-relaxed text-base">
                But personalization doesn&apos;t stop there. Quix also empowers
                you to review your tests comprehensively, allowing you to delve
                into each question to see which ones you answered correctly and
                which ones you got wrong. This detailed feedback mechanism not
                only helps reinforce your understanding of the subject matter
                but also enables targeted learning by identifying areas where
                you may need additional practice.
              </p>
            </div>
            <Image
              alt="content"
